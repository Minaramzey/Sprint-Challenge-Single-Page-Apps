...
> Answer: Because less data is processed, routing between views is generally faster with Smooth transitions and animations between views are easier to implement.
